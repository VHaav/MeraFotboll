...
class CommentController implements \Anax\DI\IInjectionAware
{
    ...
    public function homeAction()
    {
        ...
        $this->views->add('me/home', ['questions' => $recentQuestions, 'users' => $activeUsers, 'tags' => $popularTags]);
    }
